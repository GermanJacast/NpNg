      ...
      <div className='container-days'>
        <div className='days'>
          <div onClick={() => changeStateMonday(!stateMonday)}>
              <h3>Lunes</h3>
              <BiDownArrow className={`arrow ${stateMonday ? 'rotate-arrow' : ''}`.trimEnd()} />
          </div>
        ...
        <div className='days'>
          <div onClick={() => changeStateTuesday(!stateTuesday)}>
              <h3>Martes</h3>
              <BiDownArrow className={`arrow ${stateTuesday ? 'rotate-arrow' : ''}`.trimEnd()} />
          </div>
        ...
        <div className='days'>
          <div onClick={() => changeStateWednesday(!stateWednesday)}>
              <h3>Miércoles</h3>
              <BiDownArrow className={`arrow ${stateWednesday ? 'rotate-arrow' : ''}`.trimEnd()} />
          </div>
        ...
        <div className='days'>
          <div onClick={() => changeStateThursday(!stateThursday)}>
              <h3>Jueves</h3>
              <BiDownArrow className={`arrow ${stateThursday ? 'rotate-arrow' : ''}`.trimEnd()} />
          </div>
        ...
        <div className='days'>
          <div onClick={() => changeStateFriday(!stateFriday)}>
              <h3>Viernes</h3>
              <BiDownArrow className={`arrow ${stateFriday ? 'rotate-arrow' : ''}`.trimEnd()} />
          </div>
        ...
        <div className='days'>
          <div onClick={() => changeStateSaturday(!stateSaturday)}>
              <h3>Sabado</h3>
              <BiDownArrow className={`arrow ${stateSaturday ? 'rotate-arrow' : ''}`.trimEnd()} />
          </div>
